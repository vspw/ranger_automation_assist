...
- The above input item will result in the following separate policies in Ranger:-
 (i).   Dynamic:hr-oregon-ReadWrite
 (ii).  Dynamic:hr-alaska-ReadWrite
 (iii). Dynamic:hr-virginia-ReadWrite
 (iv).  Dynamic:eng-washington-ReadWrite
 (v).   Dynamic:eng-california-ReadWrite
